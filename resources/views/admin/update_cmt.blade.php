...
<div class="content-wrapper">
            ...
            <div class="page-heading">
                <h5 class=""><i class="fa fa-home"></i>/ Bình luận/ Cập nhật</h5>
            </div>
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-7" style="margin: 0 auto">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Cập nhật Bình luận</div>
                            ...
                            <div class="ibox-body">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nhập tên Bình luận" name="name" value="{{$users->name}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Thời gian:</label>
                                        <div class="input-group">
                                            <input class="form-control" type="date" placeholder="Địa chỉ email" name="email" value="{{$users->email}}">
